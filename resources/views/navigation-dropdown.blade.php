    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                @role('IT Super Admin|IT Standart User')
                    <x-jet-responsive-nav-link href="{{ route('store.listele', '1') }}">
                        Bilgi İşlem
                    </x-jet-responsive-nav-link>
                @endrole
                @role('IT Super Admin')
                    <x-jet-responsive-nav-link href="{{ route('store.listele', '2') }}">
                        Sistem ve Ağ
                    </x-jet-responsive-nav-link>
                @endrole
                @role('IT Super Admin|IT SAP')
                    <x-jet-responsive-nav-link href="{{ route('store.listele', '3') }}">
                        SAP
                    </x-jet-responsive-nav-link>
                @endrole
                @role('IT Super Admin|IT Non-SAP')
                    <x-jet-responsive-nav-link href="{{ route('store.listele', '4') }}">
                        Non-SAP
                    </x-jet-responsive-nav-link>
                @endrole
                ...
                <!-- Account Management -->
                @role('IT Super Admin')
                    <x-jet-responsive-nav-link href="{{ route('userlist.index') }}">
                        Kullanıcı Listesi
                    </x-jet-responsive-nav-link>
                @endrole
